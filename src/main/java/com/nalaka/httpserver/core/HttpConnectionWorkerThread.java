...
import com.nalaka.http.*;
import com.nalaka.httpserver.core.io.ReadFileException;
    ...
    public void run() {
        ...
        try {
            ...
            HttpResponse response = new HttpResponse.Builder()
                    .httpVersion(HttpVersion.HTTP_1_1.LITTERAL)
        ...
        switch (request.getMethod()) {
            ...
            default:
                return new HttpResponse.Builder()
                        .httpVersion(request.getBestCompatibleHttpVersion().LITTERAL)
